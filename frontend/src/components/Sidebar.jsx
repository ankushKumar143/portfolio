...
const Sidebar = () => {
    ...
    return (
        <div className="w-78 bg-[#1F2428] flex">
            <div className="w-16 bg-[#24292E] flex flex-col justify-between">
                <div>
                    <NavLink
                        to="/"
                    ...
                    >
                        <VscFiles
                            className={`w-8 h-8 ${location.pathname === "/" ? "text-gray-200" : "text-gray-500 hover:text-white cursor-pointer"}`}
                        />
                    </NavLink>
                    <NavLink
                        to="/github"
                    ...
                    >
                        <VscGithub
                            className={`w-8 h-8 ${location.pathname === "/github" ? "text-gray-200" : "text-gray-500 hover:text-white cursor-pointer"}`}
                        />
                    </NavLink>
                    <NavLink
                        to="/projects"
                    ...
                    >
                        <VscCode
                            className={`w-8 h-8 ${location.pathname === "/projects" ? "text-gray-200" : "text-gray-500 hover:text-white cursor-pointer"}`}
                        />
                    </NavLink>
                    <NavLink
                        to="/contact"
                    ...
                    >
                        <VscMail
                            className={`w-8 h-8 ${location.pathname === "/contact" ? "text-gray-200" : "text-gray-500 hover:text-white cursor-pointer"}`}
                        />
                    </NavLink>
                </div>
                <div>
                    ...
                    >
                        <VscAccount
                            className={`w-8 h-8 ${location.pathname === "/about" ? "text-gray-200" : "text-gray-500 hover:text-white cursor-pointer"}`}
                        />
                    </NavLink>
                    <NavLink
                        to="/settings"
                    ...
                    >
                        <VscSettingsGear
                            className={`w-8 h-8 ${location.pathname === "/settings" ? "text-gray-200" : "text-gray-500 hover:text-white cursor-pointer"}`}
                        />
                    </NavLink>
                </div>
            </div>
            <div className="w-62.5 flex flex-col border-r border-[#151618]">
                <h5 className="text-gray-200 text-[16px] p-2 ml-2 tracking-wider">
                    EXPLORER
                </h5>
                <div className="mt-1">
                    <button
                    ...
                    >
                        ...
                        <span className="text-gray-200 text-[15px] font-semibold p-1 tracking-wider">
                            PORTFOLIO
                        </span>
                    </button>
                    {isopen && (
                        <div className="text-gray-200 text-[16px] gap-30 ml-7">
